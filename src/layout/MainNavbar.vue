        ...
        <div class="md-collapse">
          <div class="md-collapse-wrapper">
            ...
            <md-list>
              ...
              <md-list-item href="https://www.facebook.com/artic" target="_blank">
                <svg-icon type="mdi" :path="icons[2]" />
                <p class="hidden-lg">Facebook</p>
                <md-tooltip md-direction="bottom">Like us on Facebook</md-tooltip>
              </md-list-item>
              <md-list-item href="https://www.instagram.com/artinstitutechi/" target="_blank">
                <svg-icon type="mdi" :path="icons[4]" />
...
export default {
  ...
  data() {
    return {
      extraNavClasses: '',
      toggledClass: false,
      icons: [mdiAccessPointNetwork, mdiPaletteAdvanced, mdiFacebook, mdiTwitter, mdiInstagram],
    };
  },
  computed: {
    showDownload() {
